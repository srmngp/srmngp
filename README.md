...
I'm a software engineer with experience working across various tech stacks, including Java - Spring, Scala, and cloud environments like Azure. I'm a quick learner, always eager to improve my skills and explore new technologies.
...
### Open-source projects:
  ...
  - [emoji-kitchen-api](https://github.com/srmngp/emoji-kitchen-api) - A fun API for generating custom emojis using Google's Emoji Kitchen project.
  - [thebattleship.xyz](https://github.com/srmngp/battleship) - An online web game built with React, HTML, CSS, and Javascript to practice web development skills.
...
<!--
**srmngp/srmngp** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
